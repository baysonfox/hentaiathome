...
public class HVFile {
	...
	// static stuff
	private static final java.util.regex.Pattern validHVFPattern = java.util.regex.Pattern.compile("^[a-f0-9]{40}-[0-9]{1,10}-(?:[0-9]{1,5}-[0-9]{1,5}-)?(?:jpg|png|gif|mp4|wbm|wbp|avf|jxl)$");
